...
src/app/%.o: ../src/app/%.asm
	...
	avr-gcc -x assembler-with-cpp -I"/home/alex/Dropbox/Workspace/Semester 04/RIEI1/Micro_OSII_ATMEGA256x/src/uCOSII_port" -g2 -gstabs -mmcu=atmega2560 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -c -o"$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
